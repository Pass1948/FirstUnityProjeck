...
public class UnityScript : MonoBehaviour
{
    ...
    // 유니티용 딜리게이트
    [Header("Unity Delligate")]
    public UnityAction unityAction;

    // <어트리뷰트>
    // 클래스, 프로퍼티 또는 함수 위에 명시하여 특별한 동작을 나타낼 수 있는 마커

    [Space(30)]         // []안에 내용을 넣는데 속성만 부여한다

    [Header("Unity Attribute")]
    [SerializeField]
    private int privateValue;       // 속성값이 보이지 않게
    [HideInInspector]
    public int publicValue;         // 속성갑 보이게

    [Range(0, 10)]
    public float rangeValue;        // 길이 범위

    [TextArea(3, 5)]
    public string textField;        // 텍스트 여러줄
